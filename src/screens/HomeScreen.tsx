...
const HomeScreen = ({ navigation }: any) => {
  ...
  const { updateUserLocation, updateUserDeviceId, getUserTotals, getAllDonors } = useFirebase();
      ...
      >
        ...
        <View style={[generalStyles.flexStyles]}>
          ...
          >
            ...
            <Text style={[styles.textStyles]}>{communityTotal?.length} Total Donors</Text>
          </TouchableOpacity>
